...
function MoralisDappProvider({ children }) {
  ...
  const [contractABI, setContractABI] = useState(JSON.stringify([
    {
      "inputs": [],
  ...
  const [marketAddress, setMarketAddress] = useState("0xac7f307a55c2a84aeb33d2ee1b28238eae2ba9f7"); //Smart Contract Address Here
